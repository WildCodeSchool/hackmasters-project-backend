...
--
-- Host: localhost    Database: chefs_compass
-- ------------------------------------------------------
...
SET autocommit=0; -- Explicitly set autocommit to 0
...
SET autocommit=1; -- Reset autocommit to default (1)
...
INSERT INTO `review_users` VALUES (1,1,1,'rtehyhertsdyhrs',4),(2,1,2,'ihùouih',4),(3,3,1,'oijh',5);
...
INSERT INTO `user_role_junction` VALUES (1,1),(2,1),(3,1),(2,2);
...
INSERT INTO `users` VALUES (1,'zoe.marvin@hotmail.com','user_first_name','$2a$10$IpT3SAR0amGhBzex74xUCOsA7dYAZXQ49kjQN6cp5saa4cD6K5RS.','jacqueline'),(2,'bernardo.nitzsche@hotmail.com','admin_first_name','$2a$10$rMRpH3q/e3eRlnik8I4AieNOKSj1.1Zw/45jdE2cTb/Ua0T8x2EmC','micheline'),(3,'string@t.f','remy','$2a$10$Y789nCha5pOJwTmBf9UUbuTn5ipQQHs5X3XhQFjD2CBwnG9ISXpO2','string@t.f');
...
-- Dump completed on 2023-07-20 19:40:51
